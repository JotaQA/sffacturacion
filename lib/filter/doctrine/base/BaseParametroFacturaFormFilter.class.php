...
/**
 * ParametroFactura filter form base class.
 *
 ...
 */
abstract class BaseParametroFacturaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('parametro_factura_filters[%s]');
