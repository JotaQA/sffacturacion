...
abstract class BaseDetalleActivoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'cantidad_nota_debito'              => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'cantidad_nota_debito'              => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
