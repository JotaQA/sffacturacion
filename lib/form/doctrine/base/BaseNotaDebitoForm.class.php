...
abstract class BaseNotaDebitoForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'numero_refdocumento_nota_debito' => new sfWidgetFormInputText(),
      ...
      'descuento_nota_debito'           => new sfWidgetFormInputText(),
      'id_notapedido_nota_debito'       => new sfWidgetFormInputText(),
      'razon_nota_debito'               => new sfWidgetFormInputText(),
      'glosa_nota_debito'               => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'numero_refdocumento_nota_debito' => new sfValidatorString(array('max_length' => 128, 'required' => false)),
      ...
      'descuento_nota_debito'           => new sfValidatorNumber(array('required' => false)),
      'id_notapedido_nota_debito'       => new sfValidatorInteger(array('required' => false)),
      'razon_nota_debito'               => new sfValidatorString(array('max_length' => 90, 'required' => false)),
      'glosa_nota_debito'               => new sfValidatorString(array('max_length' => 80, 'required' => false)),
