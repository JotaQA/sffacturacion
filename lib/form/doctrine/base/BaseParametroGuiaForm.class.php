...
/**
 * ParametroGuia form base class.
 *
 * @method ParametroGuia getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseParametroGuiaForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('parametro_guia[%s]');
