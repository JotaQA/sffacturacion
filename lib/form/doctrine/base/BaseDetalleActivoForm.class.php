...
abstract class BaseDetalleActivoForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'cantidad_nota_credito'             => new sfWidgetFormInputText(),
      'cantidad_nota_debito'              => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'cantidad_nota_credito'             => new sfValidatorInteger(array('required' => false)),
      'cantidad_nota_debito'              => new sfValidatorInteger(array('required' => false)),
