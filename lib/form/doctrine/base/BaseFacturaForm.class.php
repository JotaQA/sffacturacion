...
abstract class BaseFacturaForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'pctje_comision_factura' => new sfWidgetFormInputText(),
      'creador_factura'        => new sfWidgetFormInputText(),
      'emisor_factura'         => new sfWidgetFormInputText(),
      'anulador_factura'       => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'pctje_comision_factura' => new sfValidatorInteger(array('required' => false)),
      'creador_factura'        => new sfValidatorString(array('max_length' => 64)),
      'emisor_factura'         => new sfValidatorString(array('max_length' => 64, 'required' => false)),
      'anulador_factura'       => new sfValidatorString(array('max_length' => 64, 'required' => false)),
