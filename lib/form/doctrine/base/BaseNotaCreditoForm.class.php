...
abstract class BaseNotaCreditoForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'descuento_nota_credito'           => new sfWidgetFormInputText(),
      'id_notapedido_nota_credito'       => new sfWidgetFormInputText(),
      'razon_nota_credito'               => new sfWidgetFormInputText(),
      'glosa_nota_credito'               => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'descuento_nota_credito'           => new sfValidatorNumber(array('required' => false)),
      'id_notapedido_nota_credito'       => new sfValidatorInteger(array('required' => false)),
      'razon_nota_credito'               => new sfValidatorString(array('max_length' => 90, 'required' => false)),
      'glosa_nota_credito'               => new sfValidatorString(array('max_length' => 80, 'required' => false)),
